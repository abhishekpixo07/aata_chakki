...
module Spree
    module Admin
      ...
      def index
        ...
        @new_subscription_plan ="#{request.base_url}/new/subscription/plan"
      end
      ...
      def new_subscription_plan
        @subscription_plan = SolidusSubscriptions::SubscriptionPlan.new
        @route = "#{request.base_url}/create_subscription_plan"
      end
    
      def create_subscription_plan
        @subscription_plan = SolidusSubscriptions::SubscriptionPlan.new(subscription_plan_params)
    
        if @subscription_plan.save
          redirect_to admin_subscriptions_path, notice: 'Subscription plan was successfully created.'
        else
          render :new_subscription_plan
        end
      end

      def edit_subscription_plan
        @subscription_plan = SolidusSubscriptions::SubscriptionPlan.find(params[:id])
      end
      ...
      def subscription_plan_params
        params.require(:subscription_plan).permit(:title, :image, :description, :amount)
      end
