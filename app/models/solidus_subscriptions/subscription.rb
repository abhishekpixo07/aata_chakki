class SolidusSubscriptions::Subscription < ApplicationRecord
    # include Interval
    ...
    def self.ransackable_attributes(auth_object = nil)
        ["actionable_date", "billing_address_id", "created_at", "currency", "end_date", "guest_token", "id", "interval_length", "interval_units", "paused", "payment_method_id", "payment_source_id", "payment_source_type", "shipping_address_id", "skip_count", "state", "store_id", "successive_skip_count", "updated_at", "user_id","user_email_cont"]
    end
